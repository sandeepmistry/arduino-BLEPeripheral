...
/**@brief A struct containing parameters of the event of type @ref SER_PHY_HCI_EVT_HW_ERROR. */
typedef struct
{
...
typedef struct 
{
    ...
    {
        /** Parameters of the event of type @ref SER_PHY_HCI_EVT_RX_PKT_RECEIVED. */
        ser_phy_hci_pkt_params_t             received_pkt;
        /** Parameters of the event of type @ref SER_PHY_HCI_EVT_HW_ERROR. */
 ...
 *
 * @warning If the function has been already called, the function @ref ser_phy_hci_close has to be
 *          called before ser_phy_hci_open can be called again.
 *
 ...
 *                                    To call it again the function @ref ser_phy_hci_close has to
 ...
 *        schedules generating an event of type @ref SER_PHY_HCI_SLIP_EVT_TX_PKT_SENT upon transmission
 *        completion.
 *
 ...
 *
 * @note The function has to be called as a response for event @ref SER_PHY_HCI_EVT_PKT_RECEIVED
