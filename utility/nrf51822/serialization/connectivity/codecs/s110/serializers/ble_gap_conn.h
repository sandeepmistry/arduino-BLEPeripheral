...
/**@brief Decodes @ref ble_gap_address_get command request.
 *
 * @sa @ref nrf51_sd_ble_gap_address_get for packet format,
...
/**@brief Encodes @ref ble_gap_address_get command response.
 *
 * @sa @ref nrf51_sd_ble_gap_address_get for packet format.
...
/**@brief Decodes @ref ble_gap_authenticate command request.
 *
 * @sa @ref nrf51_sd_ble_gap_authenticate for packet format,
...
/**@brief Encodes @ref ble_gap_authenticate command response.
 *
 * @sa @ref nrf51_sd_ble_gap_authenticate for packet format.
...
/**@brief Decodes @ref ble_gap_adv_data_set command request.
 *
 * @sa @ref nrf51_sd_ble_gap_adv_data_set for packet format,
...
/**@brief Encodes @ref ble_gap_adv_set command response.
 *
 * @sa @ref nrf51_sd_ble_gap_adv_data_set for packet format.
...
/**@brief Decodes @ref ble_gap_adv_start command request.
 *
 * @sa @ref nrf51_sd_ble_gap_adv_start for packet format,
...
/**@brief Encodes @ref ble_gap_adv_start command response.
 *
 * @sa @ref nrf51_sd_ble_gap_adv_start for packet format.
...
/**@brief Decodes @ref ble_gap_device_name_get command request.
 *
 * @sa @ref nrf51_sd_ble_gap_device_name_get for packet format,
...
/**@brief Decodes @ref ble_gap_conn_param_update command request.
 *
 * @sa @ref nrf51_sd_ble_gap_conn_param_update for packet format,
...
/**@brief Decodes @ref ble_gap_disconnect command request.
 *
 * @sa @ref nrf51_sd_ble_gap_disconnect for packet format,
...
/**@brief Decodes @ref ble_gap_tx_power_set command request.
 *
 * @sa @ref nrf51_sd_ble_gap_tx_power_set for packet format,
...
/**@brief Decodes @ref ble_gap_ppcp_set command request.
 *
 * @sa @ref nrf51_sd_ble_gap_ppcp_set for packet format,
...
/**@brief Decodes @ref ble_gap_ppcp_get command request.
 *
 * @sa @ref nrf51_sd_ble_gap_ppcp_get for packet format,
...
/**@brief Encodes @ref ble_gap_ppcp_get command response.
 *
 * @sa @ref nrf51_sd_ble_gap_ppcp_get for packet format.
...
/**@brief Decodes @ref ble_gap_auth_key_reply command request.
 *
 * @sa @ref nrf51_sd_ble_gap_auth_key_reply for packet format,
...
/**@brief Decodes @ref ble_gap_sec_params_reply command request.
 *
 * @sa @ref nrf51_sd_ble_gap_sec_params_reply for packet format,
...
/**@brief Decodes @ref ble_gap_rssi_start command request.
 *
 * @sa @ref nrf51_sd_ble_gap_rssi_start for packet format,
...
/**@brief Decodes @ref ble_gap_rssi_stop command request.
 *
 * @sa @ref nrf51_sd_ble_gap_rssi_start for packet format,
 *     @ref ble_gap_rssi_start_rsp_enc for response encoding.
 *
 ...
 *
 * @sa @ref nrf51_sd_ble_gap_rssi_stop for packet format.
 *
 * @param[in]      return_code    Return code indicating if command was successful or not.
 * @param[in]      p_buf          Pointer to buffer where encoded data command response will be
 *                                returned.
...
/**@brief Decodes @ref ble_gap_appearance_get command request.
 *
 * @sa @ref nrf51_sd_ble_gap_appearance_get for packet format,
...
/**@brief Encodes @ref ble_gap_appearance_get command response.
 *
 * @sa @ref nrf51_sd_ble_gap_appearance_get for packet format.
...
/**@brief Decodes @ref ble_gap_appearance_set command request.
 *
 * @sa @ref nrf51_sd_ble_gap_appearance_set for packet format,
 *     @ref ble_gap_tx_power_set_rsp_enc for response encoding.
 *
 * @param[in] p_buf           Pointer to beginning of command request packet.
...
/**@brief Encodes @ref ble_gap_appearance_set command response.
 *
 * @sa @ref nrf51_sd_ble_gap_appearance_set for packet format.
 *
 * @param[in]      return_code    Return code indicating if command was successful or not.
...
/**@brief Decodes @ref ble_gap_sec_info_reply command request.
 *
 * @sa @ref nrf51_sd_ble_gap_sec_info_reply for packet format,
...
/**@brief Encodes @ref ble_gap_sec_info_reply command response.
 *
 * @sa @ref nrf51_sd_ble_gap_sec_info_reply for packet format.
 *
 * @param[in]      return_code    Return code indicating if command was successful or not.
...
/**@brief Decodes @ref ble_gap_device_name_set command request.
 *
 * @sa @ref nrf51_sd_ble_gap_device_name_set for packet format,
 *     @ref ble_gap_device_name_set for response encoding.
 *
 * @param[in] p_buf              Pointer to beginning of command request packet.
 * @param[in] packet_len         Length (in bytes) of the packet.
...
/**@brief Encodes @ref ble_gap_device_name_set command response.
 *
 * @sa @ref nrf51_sd_ble_gap_device_name_set for packet format.
 *
 * @param[in]      return_code    Return code indicating if command was successful or not.
...
/**@brief Decodes @ref ble_gap_conn_sec_get command request.
 *
 * @sa @ref nrf51_sd_ble_gap_conn_sec_get for packet format,
...
/**@brief Encodes @ref ble_gap_conn_sec_get command response.
 *
 * @sa @ref nrf51_sd_ble_gap_conn_sec_get for packet format.
