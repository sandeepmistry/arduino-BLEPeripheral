...
/**@brief Decodes @ref ble_tx_buffer_count_get command request.
 *
 * @sa @ref nrf51_sd_ble_tx_buffer_count_get for packet format,
...
/**@brief Encodes @ref ble_tx_buffer_count_get command response.
 *
 * @sa @ref nrf51_sd_ble_tx_buffer_count_get for packet format.
...
/**@brief Decodes @ref ble_version_get command request.
 *
 * @sa @ref nrf51_sd_ble_version_get for packet format,
...
/**@brief Encodes @ref ble_version_get command response.
 *
 * @sa @ref nrf51_sd_ble_version_get for packet format.
...
/**@brief Decodes @ref ble_opt_get command request.
 *
 * @sa @ref nrf51_sd_ble_opt_get for packet format,
...
/**@brief Encodes @ref ble_opt_get command response.
 *
 * @sa @ref nrf51_sd_ble_opt_get for packet format.
...
/**@brief Decodes @ref ble_opt_set command request.
 *
 * @sa @ref nrf51_sd_ble_opt_set for packet format,
...
/**@brief Encodes @ref ble_opt_set command response.
 *
 * @sa @ref nrf51_sd_ble_opt_set for packet format.
...
/**@brief Decodes @ref ble_uuid_encode command request.
 *
 * @sa @ref nrf51_sd_ble_uuid_encode for packet format,
...
/**@brief Encodes @ref ble_uuid_encode command response.
 *
 * @sa @ref nrf51_sd_ble_uuid_encode for packet format.
 ...
 * @param[in] p_uuid_le_          Pointer to the buffer with encoded UUID.
 *
 * @retval NRF_SUCCESS                Encoding success.
 * @retval NRF_ERROR_NULL             Encoding failure. NULL pointer supplied.
 * @retval NRF_ERROR_INVALID_LENGTH   Encoding failure. Incorrect buffer length.
...
/**@brief Decodes @ref ble_uuid_decode command request.
 *
 * @sa @ref nrf51_sd_ble_uuid_decode for packet format,
...
/**@brief Encodes @ref ble_uuid_decode command response.
 *
 * @sa @ref nrf51_sd_ble_uuid_decode for packet format.
...
/**@brief Decodes @ref ble_uuid_vs_add command request.
 *
 * @sa @ref nrf51_sd_ble_uuid_vs_add for packet format,
...
/**@brief Encodes @ref ble_uuid_vs_add command response.
 *
 * @sa @ref nrf51_sd_ble_uuid_vs_add for packet format.
 ...
 * @param[in,out] p_buf_len       \c in: size of \p p_buf buffer.
 *                                \c out: Length of encoded command response packet.
 * @param[in] p_uuid              Pointer to the UUID type.
 *
 * @retval NRF_SUCCESS                Encoding success.
 * @retval NRF_ERROR_NULL             Encoding failure. NULL pointer supplied.
 * @retval NRF_ERROR_INVALID_LENGTH   Encoding failure. Incorrect buffer length.
...
/**@brief Decodes @ref ble_enable command request.
 *
 * @sa @ref nrf51_sd_ble_enable for packet format,
...
/**@brief Encodes @ref ble_enable command response.
 *
 * @sa @ref nrf51_sd_ble_enable for packet format.
