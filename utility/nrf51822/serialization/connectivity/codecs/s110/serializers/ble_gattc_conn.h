...
/**@brief Decodes @ref ble_gattc_characteristics_discover command request.
 *
...
/**@brief Encodes @ref ble_gattc_characteristics_discover command response.
 *
 * @sa @ref nrf51_sd_ble_gattc_characteristics_discover_encoding for packet format.
...
/**@brief Decodes @ref ble_gattc_descriptors_discover command request.
 *
...
/**@brief Encodes @ref ble_gattc_descriptors_discover command response.
 *
 * @sa @ref nrf51_sd_ble_gattc_descriptors_discover_encoding for packet format.
...
/**@brief Decodes @ref ble_gattc_relationships_discover command request.
 *
...
/**@brief Encodes @ref ble_gattc_relationships_discover command response.
 *
 * @sa @ref nrf51_sd_ble_gattc_relationships_discover_encoding for packet format.
...
/**@brief Decodes @ref ble_gattc_primary_services_discover command request.
 *
...
/**@brief Encodes @ref ble_gattc_primary_services_discover command response.
 *
 * @sa @ref nrf51_sd_ble_gattc_primary_services_discover_encoding for packet format.
...
/**@brief Decodes @ref ble_gattc_read command request.
 *
...
/**@brief Encodes @ref ble_gattc_read command response.
 *
 * @sa @ref nrf51_sd_ble_gattc_read_encoding for packet format.
...
/**@brief Decodes @ref ble_gattc_char_values_read command request.
 *
 * @sa @ref nrf51_sd_ble_gattc_char_values_read_encoding for packet format,
 *     @ref ble_gattc_char_values_read_rsp_enc for response encoding.
 *
 * @param[in] p_buf            Pointer to beginning of command response packet.
 * @param[in] packet_len       Length (in bytes) of response packet.
 * @param[out] p_conn_handle   Pointer to connection handle.
 * @param[out] pp_handle       Pointer to pointer to handle table.
...
/**@brief Encodes @ref ble_gattc_char_values_read command response.
 *
 * @sa @ref nrf51_sd_ble_gattc_char_values_read_encoding for packet format.
...
/**@brief Decodes @ref ble_gattc_write command request.
 *
...
/**@brief Encodes @ref ble_gattc_write command response.
 *
 * @sa @ref nrf51_sd_ble_gattc_write_encoding for packet format.
...
/**@brief Decodes @ref ble_gattc_hv_confirm command request.
 *
...
/**@brief Encodes @ref ble_gattc_hv_confirm command response.
 *
 * @sa @ref nrf51_sd_ble_gattc_hv_confirm_encoding for packet format.
...
/**@brief Decodes @ref ble_gattc_char_value_by_uuid_read command request.
 *
...
/**@brief Encodes @ref ble_gattc_char_value_by_uuid_read command response.
 *
 * @sa @ref nrf51_sd_ble_gattc_char_value_by_uuid_read_encoding for packet format.
