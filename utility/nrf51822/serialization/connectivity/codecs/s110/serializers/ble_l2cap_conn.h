...
/**@brief Decodes @ref ble_l2cap_cid_register command request.
 *
 * @sa @ref nrf51_ble_l2cap_cid_register_encoding for packet format,
...
/**@brief Encodes @ref ble_l2cap_cid_register command response.
 *
 * @sa @ref nrf51_ble_l2cap_cid_register_encoding for packet format.
...
/**@brief Decodes @ref ble_l2cap_cid_unregister command request.
 *
 * @sa @ref nrf51_ble_l2cap_cid_unregister_encoding for packet format,
...
/**@brief Encodes @ref ble_l2cap_cid_unregister command response.
 *
 * @sa @ref nrf51_ble_l2cap_cid_unregister_encoding for packet format.
...
/**@brief Decodes @ref ble_l2cap_tx command request.
 *
 * @sa @ref nrf51_ble_l2cap_tx_encoding for packet format,
...
/**@brief Encodes @ref ble_l2cap_tx command response.
 *
 * @sa @ref nrf51_ble_l2cap_tx_encoding for packet format.
